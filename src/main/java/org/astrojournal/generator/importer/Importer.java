...
public abstract class Importer {
    ...
    /** The keyword denoting the first line of the report record */
    protected static String initialKeyword = ReportHeader.DATE_NAME;
    ...
    /**
     * Returns the initial keyword denoting the beginning of the report record
     * 
