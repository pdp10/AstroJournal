...
public class AJMain {
    ...
    */
     ...
     * @param obsObsDir the directory containing the single observations in latex format (output)
     * @param tsvCatDir the directory containing the tsv catalogue files (input)
     * @param obsCatDir the directory containing the catalogue in latex format (output)
     */
	...
	try {
	    ...
	    if (!generateCataloguesLatexCode()) {
	      log.warn("tsv file is not valid. Cannot generate Latex code for the catalogues.");
	      return;
	    }	    
