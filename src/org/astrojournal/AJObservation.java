...
public class AJObservation {
  ...
  /**
   * Sets the power, exit pupil and fov of the eyepieces used in this observation
  ...
  /**
   * Returns the power, exit pupil and fov of the eyepieces used in this observation
