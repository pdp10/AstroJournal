...
public class AJExporterByTarget  implements AJExporter {
   ...
   * @param latexReportsFolderByTarget the directory containing the single observations by target in latex format (output)
   * @param latexHeaderByTarget the latex header code (by target)
