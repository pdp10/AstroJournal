...
%\small 
\normalsize 
\include{latex_reports/obs20150705}
\include{latex_reports/obs20150702}
\include{latex_reports/obs20150630}
\include{latex_reports/obs20150629}
\include{latex_reports/obs20150623}
...
\include{latex_catalogues/cat1--Messier}
\include{latex_catalogues/cat2--Caldwell}
\include{latex_catalogues/cat3--NGC}
\include{latex_catalogues/cat4--IC}
\include{latex_catalogues/cat5--Stock}
\include{latex_catalogues/cat6--Melotte}
\include{latex_catalogues/cat7--Collider}
\include{latex_catalogues/cat8--DoubleStars}
\newpage 
...
{\bf Complete Caldwell Catalogue}  
\begin{longtable}{@{}lllllllllll@{}} 
\hline 
{\bf Name} & {\bf Other} & {\bf Type} & {\bf Cons} & {\bf RA}  & {\bf Dec} & {\bf Mag} & {\bf Size (arc min)} & {\bf SB} & {\bf Distance (ly)} & {\bf Common Name}               \\ 
\hline 
